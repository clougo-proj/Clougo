...
const KEYBOARD_EVENT_CODE_CODE = {
    "Backspace": 8,
    "Tab": 9,
    "Enter": 13,
    "ShiftLeft": 16,
...
Object.freeze(KEYBOARD_EVENT_CODE_CODE);
Constants.KEYBOARD_EVENT_CODE_CODE = KEYBOARD_EVENT_CODE_CODE;

// map event.key to Logo key code (matches deprecated event.which)
const KEYBOARD_EVENT_KEY_CODE = {
    "AudioVolumeMute": 173,
    "AudioVolumeDown": 174,
    "AudioVolumeUp": 175,
...
Object.freeze(KEYBOARD_EVENT_KEY_CODE);
Constants.KEYBOARD_EVENT_KEY_CODE = KEYBOARD_EVENT_KEY_CODE;
